...
import {
  ...
  export const AdressFormSchema = Yup.object().shape<ShippingAdressSchemaType>({
    ...
    postCode: Yup.string().min(5).max(5).required('Vänligen fyll i ditt postnummer.'),
    ...
    return (
      <>
        ...
        <InputField
          ...
          helperText={touched.shippingAdress?.firstName && errors.shippingAdress?.firstName}
        />
        ...
        <InputField
          ...
          helperText={touched.shippingAdress?.lastName && errors.shippingAdress?.lastName}
        />
        ...
        <InputField
          ...
          helperText={touched.shippingAdress?.streetAdress && errors.shippingAdress?.streetAdress}
        />
        ...
        <InputField
          ...
          helperText={touched.shippingAdress?.postCode && errors.shippingAdress?.postCode}
        />
        ...
        <InputField
          ...
          helperText={touched.shippingAdress?.phoneNumber && errors.shippingAdress?.phoneNumber}
        />
        ...
        <InputField
          ...
          helperText={touched.shippingAdress?.emailAdress && errors.shippingAdress?.emailAdress}
        />
      </>
    );
  }
